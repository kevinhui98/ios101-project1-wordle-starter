...
class WordGenerator {
  ...
  static let possibleWords = ["ABCDE","CALLA","Borne","CYMRY","WAIVE","CLUMP","PUNTO","BEING","SWAMP","FAMED","RUMMY","ROODY","RAVER","SLAKE","DONEE"]
  static func generateRandomWord() -> String? {
    // START YOUR CODE HERE
      var randomWord = possibleWords.randomElement()
      print(randomWord)
      return randomWord
    // END YOUR CODE HERE
  }
